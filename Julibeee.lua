...
Nếu Có Lỗi Hoặc Cần Hỗ Trợ Hãy Liên Hệ Trên Web Nhé, Bạn Có Thể Pr Cho ạn Bè Nữa Càng Tốt:D
...
local Window = OrionLib:MakeWindow({Name = "King Of Hack™", HidePremium = false, IntroText = "MinGaming Library", SaveConfig = true, ConfigFolder = "Min Gaming Hub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Profile Của Tuiiiiii",
